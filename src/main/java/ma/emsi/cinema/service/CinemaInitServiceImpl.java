...
public class CinemaInitServiceImpl implements ICinemaInitService{
    ...
    public void initCategories() {
        Stream.of("Mystery", "Thriller", "Coming Of Age").forEach(s ->
        {
    ...
    public void initFilms() {
        List<Categorie> categories = categorieRepository.findAll();
            Stream.of("Oldboy", "Identity", "Perks Of being a wallflower", "The Prestige", "Get Out", "Edge Of Seventeen").forEach(movie ->{
            Film film = new Film();
            film.setTitre(movie);
            film.setDuree((int)(Math.random()*90)+30);
            film.setPhoto(movie.replaceAll(" ", "")+".jpg");
